...
const pools: PoolConfig[] = [
  ...
  //  sousId: 1,
  //  tokenName: 'DAI',
  //  stakingTokenName: QuoteToken.COVID,
  //  stakingTokenAddress: '0xB03132DD474259FdfDF2a9D82AbC604371870614',
  //  contractAddress: {
