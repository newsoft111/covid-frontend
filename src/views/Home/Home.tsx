...
import { Heading, Text, BaseLayout } from 'covidfinancev2'
    ...
    <Page>
      <Hero>
        ...
        <Heading as="h1" scale="md" mt="10px" mb="24px" color="secondary">
          {TranslateString(545, 'Farming start (at ')}<a href="https://polygonscan.com/block/countdown/20290000" rel="noreferrer" target="_blank">block #20290000)</a>
        </Heading>  
      </Hero>
      <div>
        <Cards>
