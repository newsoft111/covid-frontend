...
import { Button, IconButton, useModal, AddIcon, Image, Flex, Text } from 'covidfinancev2'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  return (
    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      {pool.stakingTokenName === 'IRID-COVID' && <StyledCardAccent />}
        ...
        <StyledDetails>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <Image src={`/images/tokens/${stakingTokenName}.png`} width={20} height={20} alt="COVID" />
